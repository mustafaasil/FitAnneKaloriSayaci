...
{
    public partial class KategoriDuzenlemeEkraniProjeYoneticisi : Form
    {
        ProjectContext _db;
        Kategori yeniKategori;
        Kategori guncellenecekKategori;

        public KategoriDuzenlemeEkraniProjeYoneticisi()
        {
        ...
        private void KategoriDuzenlemeEkrani2_FormClosed(object sender, FormClosedEventArgs e)
        {
