...
{
    public partial class KullaniciDuzenlemeEkraniProjeYoneticisi : Form
    {
        Kullanici guncellenecekKullanici;
        ProjectContext _db;

        public KullaniciDuzenlemeEkraniProjeYoneticisi()
        {
            InitializeComponent();
        ...
        private void KullaniciDuzenlemeEkrani2_FormClosed(object sender, FormClosedEventArgs e)
        {
